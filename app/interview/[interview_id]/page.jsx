...
function Interview() {
    ...
    return (
        <div className='px-10 md:px-28 lg:px-48 xl:px-80 mt-7'>
            <div className='flex flex-col items-center justify-center border rounded-lg bg-gray-200 p-7 lg:px-33 xl:px-52 mb-20'>
                ...
                <h2 className='font-bold text-xl'>{interviewData?.jobPositon}</h2>
                <h2 className='flex gap-2 items-center text-gray-700 mt-3'><Clock className='h-4 w-4'/> {interviewData?.duration} </h2>
