                ...
                <DialogHeader>
                    ...
                    <DialogDescription asChild>
                        <div className='mt-5'>
                            <div className='flex justify-between items-center'>
                                <div className='flex items-center gap-5'>
                                    ...
                                    <div>
                                        ...
                                        <h2 className='text-sm text-gray-700'>{candidate?.userEmail}</h2>
                                    </div>   
                                </div>
                            ...
                            <div className={`p-10  mt-10 flex items-center justify-between rounded-md ${feedback?.Recommendation=='No'?'bg-red-100':'bg-green-100'}`}>
                                <div>
